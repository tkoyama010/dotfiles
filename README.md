...
- `claude/skills/`: Agent skills vendored from [cursor/plugins](https://github.com/cursor/plugins) (MIT). Not auto-loaded; copy the ones you want into `~/.claude/skills/`. See `claude/NOTICE.md` for attribution and the pinned upstream commit.
